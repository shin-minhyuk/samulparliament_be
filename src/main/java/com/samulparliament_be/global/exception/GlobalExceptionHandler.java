...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleBusinessException(BusinessException e,
                ...
                log.warn("[{}] {} | URI: {} | Method: {}", errorCode.getCode(), e.getMessage(),
        ...
        public ResponseEntity<ErrorResponse> handleValidationException(
                ...
                log.warn("[VALIDATION] {} | URI: {} | Method: {}", errorMessage,
                                request.getRequestURI(), request.getMethod());
        ...
        // 권한 없음 예외 처리 (Spring Security @PreAuthorize 등)
        @ExceptionHandler({org.springframework.security.access.AccessDeniedException.class,
                        org.springframework.security.authorization.AuthorizationDeniedException.class})
        public ResponseEntity<ErrorResponse> handleAccessDeniedException(Exception e,
                        HttpServletRequest request) {

                log.warn("[ACCESS_DENIED] URI: {} | Method: {} | 사용자 접근 권한이 없습니다",
                                request.getRequestURI(), request.getMethod());
        ...
        public ResponseEntity<ErrorResponse> handleIllegalArgumentException(
                ...
                log.warn("[INVALID_INPUT] {} | URI: {} | Method: {}", e.getMessage(),
                                request.getRequestURI(), request.getMethod());
        ...
        public ResponseEntity<ErrorResponse> handleUnexpectedException(Exception e,
                ...
                log.error("[UNEXPECTED] URI: {} | Method: {} | Error: {}", request.getRequestURI(),
